...
pkgdatadir = $(datadir)/apertium-sux
pkgincludedir = $(includedir)/apertium-sux
pkglibdir = $(libdir)/apertium-sux
pkglibexecdir = $(libexecdir)/apertium-sux
...
CONFIG_CLEAN_FILES = apertium-sux.pc
...
am__installdirs = "$(DESTDIR)$(apertium_suxdir)" \
...
ACLOCAL = ${SHELL} '/Users/himanshu/GSOC/Apertium_MT/apertium-sux/missing' aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
APERTIUM_CFLAGS = -I/usr/local/include/apertium-3.8 -I/usr/local/lib/apertium-3.8/include
APERTIUM_LIBS = -L/usr/local/lib -lapertium3
AUTOCONF = ${SHELL} '/Users/himanshu/GSOC/Apertium_MT/apertium-sux/missing' autoconf
AUTOHEADER = ${SHELL} '/Users/himanshu/GSOC/Apertium_MT/apertium-sux/missing' autoheader
AUTOMAKE = ${SHELL} '/Users/himanshu/GSOC/Apertium_MT/apertium-sux/missing' automake-1.16
AWK = gawk
...
CTAGS = ctags
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"Apertium\ Sumerian\" -DPACKAGE_TARNAME=\"apertium-sux\" -DPACKAGE_VERSION=\"0.1.0\" -DPACKAGE_STRING=\"Apertium\ Sumerian\ 0.1.0\" -DPACKAGE_BUGREPORT=\"https://github.com/apertium/apertium-sux/issues\" -DPACKAGE_URL=\"https://wiki.apertium.org/wiki/Apertium-sux\" -DPACKAGE=\"apertium-sux\" -DVERSION=\"0.1.0\"
ECHO_C = \c
ECHO_N = 
ECHO_T = 
ETAGS = etags
HFSTOSPELL_CFLAGS = -I/usr/local/include
HFSTOSPELL_LIBS = -L/usr/local/lib -lhfstospell
HFST_CFLAGS = -I/usr/local/include/hfst/
HFST_LIBS = -L/usr/local/lib -lhfst
...
LIBS = 
LTLIBOBJS = 
LTTOOLBOX_CFLAGS = -I/usr/local/include/lttoolbox-3.6
LTTOOLBOX_LIBS = -L/usr/local/lib -llttoolbox3
MAKEINFO = ${SHELL} '/Users/himanshu/GSOC/Apertium_MT/apertium-sux/missing' makeinfo
MKDIR_P = ./install-sh -c -d
PACKAGE = apertium-sux
PACKAGE_BUGREPORT = https://github.com/apertium/apertium-sux/issues
PACKAGE_NAME = Apertium Sumerian
PACKAGE_STRING = Apertium Sumerian 0.1.0
PACKAGE_TARNAME = apertium-sux
PACKAGE_URL = https://wiki.apertium.org/wiki/Apertium-sux
PACKAGE_VERSION = 0.1.0
PATH_SEPARATOR = :
PKG_CONFIG = /opt/homebrew/bin/pkg-config
PKG_CONFIG_LIBDIR = 
PKG_CONFIG_PATH = /usr/local/lib/pkgconfig:/usr/local/share/pkgconfig:/usr/local/lib/pkgconfig:/usr/local/share/pkgconfig::/usr/local/share/pkgconfig:/usr/local/lib/pkgconfig
REGTEST_CFLAGS = 
REGTEST_LIBS = 
SET_MAKE = 
SHELL = /bin/sh
STRIP = 
VERSION = 0.1.0
abs_builddir = /Users/himanshu/GSOC/Apertium_MT/apertium-sux
abs_srcdir = /Users/himanshu/GSOC/Apertium_MT/apertium-sux
abs_top_builddir = /Users/himanshu/GSOC/Apertium_MT/apertium-sux
abs_top_srcdir = /Users/himanshu/GSOC/Apertium_MT/apertium-sux
am__leading_dot = .
...
install_sh = ${SHELL} /Users/himanshu/GSOC/Apertium_MT/apertium-sux/install-sh
...
###############################################################################
#
#   apertium_sux_dir: This is where the compiled binaries go
#   apertium_sux_srcdir: This is where the source files go
apertium_suxdir = $(prefix)/share/apertium/$(BASENAME)/
apertium_sux_srcdir = $(prefix)/share/apertium/$(BASENAME)/
apertium_sux_DATA = $(TARGETS_COMMON) \
	$(BASENAME).$(LANG1).lexd	\
	$(BASENAME).$(LANG1).twol	\
	$(BASENAME).$(LANG1).rlx	\
	$(BASENAME).post-$(LANG1).dix	\
...
$(am__aclocal_m4_deps):
apertium-sux.pc: $(top_builddir)/config.status $(srcdir)/apertium-sux.pc.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
install-apertium_suxDATA: $(apertium_sux_DATA)
	@$(NORMAL_INSTALL)
	@list='$(apertium_sux_DATA)'; test -n "$(apertium_suxdir)" || list=; \
	if test -n "$$list"; then \
	  echo " $(MKDIR_P) '$(DESTDIR)$(apertium_suxdir)'"; \
	  $(MKDIR_P) "$(DESTDIR)$(apertium_suxdir)" || exit 1; \
	fi; \
	for p in $$list; do \
	...
	while read files; do \
	  echo " $(INSTALL_DATA) $$files '$(DESTDIR)$(apertium_suxdir)'"; \
	  $(INSTALL_DATA) $$files "$(DESTDIR)$(apertium_suxdir)" || exit $$?; \
	done

uninstall-apertium_suxDATA:
	@$(NORMAL_UNINSTALL)
	@list='$(apertium_sux_DATA)'; test -n "$(apertium_suxdir)" || list=; \
	files=`for p in $$list; do echo $$p; done | sed -e 's|^.*/||'`; \
	dir='$(DESTDIR)$(apertium_suxdir)'; $(am__uninstall_files_from_dir)
...
installdirs:
	for dir in "$(DESTDIR)$(apertium_suxdir)" "$(DESTDIR)$(pkgconfigdir)"; do \
...
install-data-am: install-apertium_suxDATA install-data-local \
...
uninstall-am: uninstall-apertium_suxDATA uninstall-local \
	uninstall-pkgconfigDATA
...
.PHONY: all all-am am--refresh check check-am clean clean-generic \
	...
	info-am install install-am install-apertium_suxDATA \
	...
	uninstall uninstall-am uninstall-apertium_suxDATA \
